...
public class CustomObjectLab {
    public static void main(String[] args) {
        ...
        Book book1 = new Book("ISBN000001", "java msa", "amazon", 12000);
        Book book2 = new Book("ISBN000001", "java msa2", "amazon", 14000);
        Book book3 = new Book("ISBN000002", "kuber", "amazian", 15000);
        ...
        System.out.println("list.contains(book1) : " + list.contains(book1));
        System.out.println("list.contains(book2) : " + list.contains(book2));
        System.out.println("list.contains(book3) : " + list.contains(book3));
    }
}
